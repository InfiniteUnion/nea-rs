...
pub struct RainfallInput<S: satay_runtime::StringStorage = String> {
...
impl<S: satay_runtime::StringStorage> RainfallInput<S> {
    pub fn new() -> Self {
        Self {
            date: None,
...
impl<S: satay_runtime::StringStorage> Default for RainfallInput<S> {
    fn default() -> Self {
        Self::new()
    }
}
...
/// - Unit of measure for readings is `mm`
#[derive(Debug, Clone, PartialEq)]
pub enum RainfallOperationResponse<S: satay_runtime::StringStorage = String> {
    /// Rainfall Information
    Ok(RainfallResponse<S>),
...
///
/// - Unit of measure for readings is `mm`
pub fn rainfall_parts<S: satay_runtime::StringStorage>(
