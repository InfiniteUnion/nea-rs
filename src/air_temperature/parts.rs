...
pub struct AirTemperatureInput {
...
impl Default for AirTemperatureInput {
    fn default() -> Self {
        Self::new()
    }
}
...
/// - Unit of measure for readings is `°C`
#[derive(Debug, Clone, PartialEq)]
pub enum AirTemperatureOperationResponse {
    /// Air Temperature Information
    Ok(AirTemperatureResponse),
