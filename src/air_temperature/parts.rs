...
pub struct AirTemperatureInput<S: satay_runtime::StringStorage = String> {
...
impl<S: satay_runtime::StringStorage> AirTemperatureInput<S> {
    pub fn new() -> Self {
        Self {
            date: None,
...
impl<S: satay_runtime::StringStorage> Default for AirTemperatureInput<S> {
    fn default() -> Self {
        Self::new()
    }
}
...
/// - Unit of measure for readings is `°C`
#[derive(Debug, Clone, PartialEq)]
pub enum AirTemperatureOperationResponse<S: satay_runtime::StringStorage = String> {
    /// Air Temperature Information
    Ok(AirTemperatureResponse<S>),
