...
pub struct WindDirectionInput<S: satay_runtime::StringStorage = String> {
...
impl<S: satay_runtime::StringStorage> WindDirectionInput<S> {
    pub fn new() -> Self {
        Self {
            date: None,
...
impl<S: satay_runtime::StringStorage> Default for WindDirectionInput<S> {
    fn default() -> Self {
        Self::new()
    }
}
...
/// - Unit of measure for readings is `°`
#[derive(Debug, Clone, PartialEq)]
pub enum WindDirectionOperationResponse<S: satay_runtime::StringStorage = String> {
    /// Wind Direction Information
    Ok(WindDirectionResponse<S>),
